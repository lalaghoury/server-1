    ...
    <AppLayout>
      <div className="blog-details">
        <div className="blog-details-head">
          ...
          <div
            className="blog-details-heading"
          ...
          <div className="blog-details-user">
            <span className="blog-details-user-card">
              <img
                ...
                alt="userimage"
                style={{ marginRight: 10, width: 40, borderRadius: "50%" }}
              />
              <h4>
                <Link
            ...
            <span className="blog-details-user-card">
              <CalendarOutlined
                style={{ fontSize: 22, color: "#B55D51", marginRight: 5 }}
              />
        ...
        <div className="blog-details-body">
          <div className="blog-left">
            ...
            <div className="blog-comments">
              {auth?.user ? (
                <CommentsSection Id={blog_id} used={"Blog"} />
              ) : (
                <div className="tac">
                ...
                {allBlogs &&
                  allBlogs?.slice(0, 3).map((recentBlog) => (
                    <Card
                      ...
                      cover={
                        <img alt={recentBlog.title} src={recentBlog.image} />
                      }
                    >
                      <center>
